...
/**
 * A POJO for all information need to reconstruct the node icon client side.
 *
...
public class IconInfo {
    ...
    /**
     * Returns the icon's image as base64 encoded string.
     *
     * @return the icon's image as a base64 encoded string
     */
    ...
    /**
     * Sets the image data for the icon.
     *
     * @param data the base64 encoded representation of the icon image
     */
