 ...
 * @since 8.4
 */
public class DBContentProviderFactory extends AbstractContentProviderFactory {

    public static final String ID = "org.knime.workbench.explorer.DB";
    ...
    public AbstractContentProvider createContentProvider(final String mountID) {
        return new DBContentProvider(this, mountID);
    }
     ...
     */
    @Override
    public AdditionalInformationPanel createAdditionalInformationPanel(final Composite parent, final Text mountIDInput) {
        return null;
    }
