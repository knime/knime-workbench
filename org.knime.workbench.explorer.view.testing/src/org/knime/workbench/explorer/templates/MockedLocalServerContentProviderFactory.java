 ...
 */
public class MockedLocalServerContentProviderFactory extends LocalWorkspaceContentProviderFactory {

    public static final String ID = "mocked_server_content_provider_for_testing";
    ...
    public AbstractContentProvider createContentProvider(final String mountID, final String content) {
        return new MockedLocalServerContentProvider(this, mountID);
    }
