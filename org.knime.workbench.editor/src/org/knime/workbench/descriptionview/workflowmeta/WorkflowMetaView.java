...
public class WorkflowMetaView extends ScrolledComposite implements MetadataModelFacilitator.ModelObserver {
    ...
    private static final String NO_TITLE_TEXT = "Not set.";
    ...
    @SuppressWarnings("unused") // just for neat object graphs
    ...
    public void selectionChanged(final IStructuredSelection selection) {
        ...
        if (knimeExplorerItem) {
            ...
            try {
                ...
                MetaInfoFile.createOrGetMetaInfoFile(metadataFile, isWorkflow);
            ...
            metadataFile = MetaInfoFile.createOrGetMetaInfoFileForDirectory(rf.getFile(), true);
            workflowName = projectWM.getName();
    ...
    private void performSave() {
        ...
        final Job job = new WorkspaceJob("Saving workflow metadata...") {
            ...
            public IStatus runInWorkspace(final IProgressMonitor monitor) throws CoreException {
                try {
                    m_modelFacilitator.writeOldStyleMetadata(m_metadataFile);
