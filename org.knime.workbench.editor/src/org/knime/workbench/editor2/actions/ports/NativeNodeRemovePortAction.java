 ...
 */
final class NativeNodeRemovePortAction extends AbstractNativeNodePortAction {
     ...
     */
    NativeNodeRemovePortAction(final NodeContainerEditPart editPart,
    ...
    protected boolean modifyPorts() {
        return getPortGroup(ExtendablePortGroup.class).removeLastPort() != null;
    }
