...
/**
 * Editor action to show the progress of an executing workflow.
 *
 * @author Martin Horn, KNIME GmbH, Konstanz, Germany
 */
public class ShowProgressEditorAction extends AbstractEditorAction {
    /**
     * {@inheritDoc}
     */
    @Override
    protected AbstractNodeAction createAction(final WorkflowEditor editor) {
        return new ShowProgressAction(editor);
    }
}
